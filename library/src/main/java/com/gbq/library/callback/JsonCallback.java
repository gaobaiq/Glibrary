...
//                .params("token", "3215sdf13ad1f65asd4f3ads1f");
        request.params(OkGoRequest.getAppParams());
    }
    ...
    public T convertSuccess(Response response) throws Exception {
        ...
        if (typeArgument == Void.class) {
            ...
            //有数据类型，表示有data
            BaseResponse baseResponse = ConvertUtils.fromJson(jsonReader, type);
            response.close();
