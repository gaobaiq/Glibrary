...
import com.gbq.library.okgo.cookie.CookieJarImpl;
import com.gbq.library.okgo.cookie.store.CookieStore;
import com.gbq.library.okgo.https.HttpsUtils;
import com.gbq.library.okgo.interceptor.HttpLoggingInterceptor;
import com.gbq.library.okgo.model.HttpHeaders;
import com.gbq.library.okgo.model.HttpParams;
import com.gbq.library.okgo.request.DeleteRequest;
import com.gbq.library.okgo.request.GetRequest;
import com.gbq.library.okgo.request.HeadRequest;
import com.gbq.library.okgo.request.OptionsRequest;
import com.gbq.library.okgo.request.PostRequest;
import com.gbq.library.okgo.request.PutRequest;
...
/**
 * 类说明：网络请求的入口类
 *      拷贝github  https://github.com/jeasonlzy/okhttp-OkGo.git
 * Author: Kuzan    <https://github.com/gaobaiq></br>
 * Date: 2017/5/25 11:14.
 */
public class OkGo {
