...
import com.gbq.library.okgo.adapter.CacheCall;
import com.gbq.library.okgo.adapter.Call;
import com.gbq.library.okgo.adapter.CallAdapter;
import com.gbq.library.okgo.adapter.DefaultCallAdapter;
...
import com.gbq.library.okgo.convert.Converter;
...
/**
 * 类说明：所有请求的基类，其中泛型 R 主要用于属性设置方法后，返回对应的子类型，以便于实现链式调用
 * Author: Kuzan
 * Date: 2017/5/25 13:46.
 */
