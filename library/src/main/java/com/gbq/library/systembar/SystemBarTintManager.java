package com.gbq.library.systembar;
...
/**
 * 类说明：Class to manage status and navigation bar tint effects when using KitKat translucent system UI modes.
 * Author: Kuzan
 * Date: 2017/5/25 18:29.
 */
